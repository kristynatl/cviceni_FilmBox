...
// BONUS - Přidejte do pole s filmy nějaký další dle vlastního výběru.
...
// Na stránce se seznamem filmů vypište karty se všemi filmy z pole filmy - Na konci souboru seznam.js pomocí document.querySelector vyhledejte prvek s id seznam-filmu.
const moviesList = document.querySelector('#seznam-filmu');

// Vymažte tomuto prvku jeho vnitřní HTML, aby byl prázdný.
moviesList.innerHTML = '';

// Pomocí cyklu projděte všechny filmy z předpřipraveného pole a pro každý přidejte do prvku #seznam-filmu HTML doplněné o patřičné informace (název, ochutnávku, plakát).
// Přidejte do odkazu href za film.html znak mřížky (#) a za něj ještě unikátní identifikátor (id), který má každý film jiný
filmy.forEach((film) => {
